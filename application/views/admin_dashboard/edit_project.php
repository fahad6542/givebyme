			...
			<ul class="breadcrumb">
				<li><a href="#">Home</a></li>
				<li class="active">Edit Campaign: <strong><?php echo $project['title']; ?> </strong></li>
			</ul>
			<!-- END BREADCRUMB -->
			...
			<div class="page-content-wrap">
				<div class="row">
					<div class="col-md-12">
						<form method="post" role="form" id="form_project" action="<?php echo base_url(); ?>projects/update/<?php echo $project['pid']; ?>" class="form-horizontal" enctype="multipart/form-data">
								...
								<div class="panel-body tab-content">
									<div class="tab-pane active" id="tab-first">
										...
										<div class="form-group">
											...
											<div class="col-md-6 col-xs-12">
												<textarea class="form-control" name="description" rows="5" cols="150"  id="desTinyc" ><?php echo $project['description']; ?></textarea>
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <select class="form-control" name="dealtype" required>
                                        ...
                                        <option value="<?php echo $deal['id'] ?>" 
                                            <?php if ($companyItem["dealtype"]==$deal["id"]) {?>
                                             selected="selected"
                                        <?php }?> ><?php echo $deal['name'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
									...
									<div class="tab-pane" id="tab-second"> -->
										...
										<div class="form-group">
											<label class="col-md-3 col-xs-12 control-label">Campaign Value</label>
											<div class="col-md-6 col-xs-12">
									...
									<div class="tab-pane" id="tab-third"> -->
										...
										<h4>Estimated yields /estimate yield for 3 years</h4>
                                        <br>
                                        <div class="form-group">
                                            <label class="col-md-3 col-xs-12 control-label">Estimate yield for 1st year</label>
                                            <div class="col-md-6 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 col-xs-12 control-label">Estimate yield for 2nd year</label>
                                            <div class="col-md-6 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 col-xs-12 control-label">Estimate yield for 3rd year</label>
                                            <div class="col-md-6 col-xs-12">
                                        ...
                                        <h4>Information about income / Information about rent</h4>
                                        <br>
                                        <div class="form-group">
                                            <label class="col-md-3 col-xs-12 control-label">Gross Income</label>
                                            <div class="col-md-6 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 col-xs-12 control-label">Net Income</label>
                                            <div class="col-md-6 col-xs-12">
