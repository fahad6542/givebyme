...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16"  href="<?php echo base_url(); ?>assets/user-dashboard/img/favicon.png">
    <title>Welcome to Lavaniworld</title>
	<link rel="author" href="fahad6542@gmail.om" />
    <!-- Custom CSS -->
    <!-- Custom CSS -->
    <link href="<?php echo base_url(); ?>assets/dark/css/style.css" rel="stylesheet">
    <!-- You can change the theme colors from here -->
    <link href="<?php echo base_url(); ?>assets/dark/css/colors/green-dark.css" id="theme" rel="stylesheet">
...
<![endif]-->
    ...
    <link href="<?php echo base_url(); ?>assets/dark/plugins/select2/dist/css/select2.min.css" rel="stylesheet" type="text/css" />
</head>
    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo base_url(); ?>">
                        ...
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <!-- <img src="<?php echo base_url(); ?>assets/dark/images/logo-icon.png" alt="homepage" class="dark-logo" /> -->
                            <!-- Light Logo icon -->
                            <!-- <img src="<?php echo base_url(); ?>assets/dark/images/logo-light-icon.png" alt="homepage" class="light-logo" /> -->
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text --><span>
                            <!-- dark Logo text -->
                            <!-- <img src="<?php echo base_url(); ?>assets/dark/images/logo-text.png" alt="homepage" class="dark-logo" /> -->
                            <!-- Light Logo text -->
                            <!-- <img src="<?php echo base_url(); ?>assets/dark/images/logo-light-text.png" class="light-logo" alt="homepage" /></span> -->
                            <h3 style="font-weight: bold;font-size: 28px;letter-spacing: 2px;margin-top:-47px;">Lavaniworld</h3>
                        </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                                            ...
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container"> <img class="d-block img-fluid"
                                                            src="<?php echo base_url(); ?>assets/dark/images/big/img1.jpg" alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid"
                                                            src="<?php echo base_url(); ?>assets/dark/images/big/img2.jpg" alt="Second slide">
                                                    </div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid"
                                                            src="<?php echo base_url(); ?>assets/dark/images/big/img3.jpg" alt="Third slide"></div>
                                                </div>
                                            </div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center position-relative">
                                            ...
                                            <!-- Message -->
                                            <a href="<?php echo base_url();?>settings" class="border-bottom d-block text-decoration-none py-2 px-3">
                                        ...
                                        <div class="message-center">
                                            ...
                                            <a href="#" class="border-bottom d-block text-decoration-none py-2 px-3">
                                                <div class="user-img position-relative d-inline-block mr-2 mb-3"> <img
                                                        src="<?php echo base_url(); ?>assets/dark/images/users/1.jpg" alt="user"
                                            ...
                                            <a href="#" class="border-bottom d-block text-decoration-none py-2 px-3">
                                                <div class="user-img position-relative d-inline-block mr-2 mb-3"> <img
                                                        src="<?php echo base_url(); ?>assets/dark/images/users/2.jpg" alt="user"
                                                        class="rounded-circle"> <span
                                            ...
                                            <a href="#" class="border-bottom d-block text-decoration-none py-2 px-3">
                                                <div class="user-img position-relative d-inline-block mr-2 mb-3"> <img
                                                        src="<?php echo base_url(); ?>assets/dark/images/users/3.jpg" alt="user"
                                                        class="rounded-circle"> <span
                                            ...
                                            <a href="#" class="border-bottom d-block text-decoration-none py-2 px-3">
                                                <div class="user-img position-relative d-inline-block mr-2 mb-3"> <img
                                                        src="<?php echo base_url(); ?>assets/dark/images/users/4.jpg" alt="user"
                                                        class="rounded-circle"> <span
                                                        class="profile-status pull-right d-inline-block position-absolute bg-warning rounded-circle"></span>
                                                </div>
                                                <div class="mail-contnet d-inline-block align-middle">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href=""
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src="<?php echo base_url(); ?>assets/dark/images/users/1.jpg" alt="user" class="profile-pic" /></a>
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="u-img"><img src="<?php echo base_url(); ?>assets/dark/images/users/1.jpg" alt="user"></div>
                                            <div class="u-text">
                                                <h4>Steave Jobs</h4>
                                                <p class="text-muted">varun@gmail.com</p><a href="<?php echo base_url();?>settings"
                                    ...
                                    <li><a href="<?php echo base_url();?>settings"><i class="ti-user"></i> My Profile</a></li>
                                    <li><a href="#"><i class="ti-wallet"></i> My Balance</a></li>
                                    <li><a href="#"><i class="ti-email"></i> Inbox</a></li>
                                    <li role="separator" class="divider"></li>
                                    <li><a href="<?php echo base_url();?>settings"><i class="ti-settings"></i> Account Setting</a></li>
                                    <li role="separator" class="divider"></li>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                <!-- User profile -->
                <div class="user-profile" style="background: url(<?php echo base_url(); ?>assets/dark/images/background/user-info.jpg) no-repeat;">
                    <!-- User profile image -->
                    <div class="profile-img"> <img src="<?php echo base_url(); ?>assets/dark/images/users/1.jpg" alt="user" /> </div>
                    <!-- User profile text-->
                    <div class="profile-text"> <a href="#" class="dropdown-toggle link u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">Markarn Doe <span class="caret"></span></a>
                        <div class="dropdown-menu animated flipInY">
                            <a href="<?php echo base_url();?>settings" class="dropdown-item"><i class="ti-user"></i> My Profile</a>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>industries" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Category</span></a>
                        </li>
                        <li>
                            <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-cloud-upload"></i><span class="hide-menu">Upload Campaign</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url() ?>new-project">Add new Campaigns</a></li>
                                <li><a href="<?php echo base_url() ?>projects">View Campaigns</a></li>
                                <li><a href="<?php echo base_url() ?>projects/viewProjects/0">Disabled Campaigns</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>transections" aria-expanded="false"><i class="mdi mdi-credit-card-plus"></i><span class="hide-menu">Payments</span></a>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>users" aria-expanded="false"><i class="fas fa-address-book"></i><span class="hide-menu">Manage Users</span></a>
                        </li>
