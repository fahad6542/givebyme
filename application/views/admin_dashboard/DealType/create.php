                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Manage Deal Types</strong></h3>
                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="panel panel-default">
                                                <form method="post" role="form" id="form_industry" action="<?php echo base_url(); ?>DealType/save" class="form-horizontal">
                                                    <div class="panel-body">
