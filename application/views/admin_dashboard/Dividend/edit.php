                ...
                <div class="panel-body panel-body-open panel-body " id="accTwoColTwo">
                    ...
                    <form method="post" action="<?php echo base_url();?>Dividend/save">
                        ...
                        <input type="hidden" value="<?php echo $payToEntra;?>" name="amount" readonly="readonly" required="required">
                                ...
                                <td><?php echo $dividend["transaction_id"];?><input type="hidden" class="form-control" name="tansaction_id" required="required"></td>
                                <td><?php echo $dividend["paid_on"];?><input type="hidden" class="form-control" name="date" required="required"></td>
                        </tr>
