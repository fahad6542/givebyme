                    ...
                    <div class="col-md-12">
                        <form method="post" role="form" id="form_project" action="<?php echo base_url(); ?>Company/update" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-pane active" id="tab-first">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <input type="text" class="form-control" name="title" value="<?php echo $companyItem["title"];?>" required/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <input type="text" class="form-control" name="partner" value="<?php echo $companyItem["partner"];?>" required/>
                           ...
                           <div class="form-group">
                                ...
                                <div class="panel-footer">
                                    <a href="<?php echo base_url().'document/create/'.$companyItem["pid"];?>" title="Don't Save" class="btn btn-primary pull-right left-gap" role="button">Next </a>
