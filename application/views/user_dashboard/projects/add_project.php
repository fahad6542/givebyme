<!-- START BREADCRUMB -->
            ...
            <div class="page-content-wrap">
                <div class="row">
                    <div class="col-md-12">
                        <form method="post" role="form" id="form_project" action="<?php echo base_url(); ?>UserProjects/addNewProject" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="panel-body tab-content">
                                    <div class="tab-pane active" id="tab-first">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <textarea class="form-control" name="description" rows="5" cols="150" required></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <input type="text" class="form-control" name="dividendBasis"/>
                                            </div>
                                        </div>                                        
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <input type="text" class="form-control" name="durationForComplete" required/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="panel-footer">
                                    <a href="<?php echo base_url().'document/create';?>" title="Don't Save" class="btn btn-primary pull-right left-gap" role="button">Next </a>

                                    <button class="btn btn-primary pull-right">Add Project<span class="fa fa-floppy-o fa-right"></span></button>
                                </div>
                            </div>
                        </form>
                    </div>
